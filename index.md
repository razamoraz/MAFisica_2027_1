...
```mermaid
graph LR
    B1["Bloque 1<br>S-L, Fourier & Bessel"] --> B2["Bloque 2<br>Dispersión & Continuo"]
    B2 --> B3["Bloque 3<br>Espectro Mixto & Pozos"]
    B3 --> B4["Bloque 4<br>Calor & Legendre"]
    B4 --> B5["Bloque 5<br>Laplace & Ondas"]
    B5 --> B6["Bloque 6<br>Mathieu & Estabilidad"]
```
